...
if len(dbFiles) > 0:
    ...
    os.system("python multiCREATETABLE.py {0}".format(createTableArgv))
    os.system("python multiSQLITETOMYSQLRAW.py {0}".format(SQLITETOMYSQLARGV))
    os.system("python multiSQLITETOMYSQLSORTED.py {0}".format(SQLITETOMYSQLARGV))
...
os.system("python multi-move-to-archive.py")
